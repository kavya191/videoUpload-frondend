    ...
    <Container style={{background:"dark",height:"100vh"}}>
      <Row>
        ...
        <div className='mt-5 text-center text-info '>
          ...
          <p className='text-white'>Video Uploader is a free and open-source, portable, cross-platform media player software and streaming media server developed by the VideoLAN project. VLC is available for desktop operating systems and mobile platforms, such as Android, iOS and iPadOS. <var></var></p>
            <div>
              <Link to='/home'>
